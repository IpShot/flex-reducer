...
Flexible reducer for a React app data management. Use it in a component as a regular `useReducer` react hook. Its data will be available for all other components via [useSelector](https://react-redux.js.org/next/api/hooks#useselector) hook until the owner component unmounted.
